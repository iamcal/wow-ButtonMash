...
function ButtonMash.ModuleOnEvent(event, ...)
...
function ButtonMash.CreateUI()
	...
	if (ButtonMash.current_talent_spec == 2) then
		...
		ButtonMash.PointBoxes[1] = ButtonMash.CreateComboBox(41*0, 41, 40, 20);
		ButtonMash.PointBoxes[2] = ButtonMash.CreateComboBox(41*1, 41, 40, 20);
		ButtonMash.PointBoxes[3] = ButtonMash.CreateComboBox(41*2, 41, 40, 20);
		ButtonMash.PointBoxes[4] = ButtonMash.CreateComboBox(41*3, 41, 40, 20);
		ButtonMash.PointBoxes[5] = ButtonMash.CreateComboBox(41*4, 41, 40, 20);
...
function ButtonMash.CreateComboBox(x, y, w, h)
...
function ButtonMash.UpdateFrame()
	...
	if (ButtonMash.current_talent_spec == 2) then
		...
		local status = ButtonMash.GetCombatRogueShotStatus();
...
function ButtonMash.GetCombatRogueShotStatus()
